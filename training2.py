...
if __name__ == "__main__":
    ...
    logger.info("Starting fine-tuning training...")  # Log start
    ...
    try:
        ...
        logger.error("Run training.py first.")  # Log error
        sys.exit(1)  # Exit program
    molding_data = [f"{term} is a key parameter in injection molding." for term in molding_terms] # Loads molding data
    all_sentences = all_sentences + molding_data  # Combine sentences
    ...
    logger.info("Saved model_updated.pkl")  # Log saving
